      ...
      <Container maxWidth="7xl" className="z-10 flex justify-center p-4">
        <div className="flex flex-col gap-4 text-slate-50">
          <div className="flex flex-col gap-4">
            ...
            <span className="text-sm text-gray-400 w-[400px]">
          ...
          <div
            className="flex flex-row gap-4 p-6 rounded-xl"
            style={{
              background: 'rgba(255, 255, 255, 0.08)',
              backdropFilter: 'blur(35px)',
            }}
          >
            <div className="flex flex-col flex-1 gap-2 text-gray-400">
            ...
            <div className="flex flex-col items-center justify-center flex-1 gap-4 text-gray-400">
              ...
              <div className="flex flex-row items-center flex-grow gap-2 text-gray-400">
                <LinkExternal>Uniswap</LinkExternal>
              </div>
            </div>
          </div>
        </div>
