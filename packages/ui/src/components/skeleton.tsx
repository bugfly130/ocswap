  ...
  return (
    <div
      ...
      className={classNames(
        props.className,
        'rounded-lg overflow-hidden animate-pulse bg-black/[0.10] /[0.10]',
      )}
    />
  )
}
...
function SkeletonCircle(props: CircleProps) {
  return (
    <div
      ...
      className={classNames(
        props.className,
        'rounded-full overflow-hidden animate-pulse bg-black/[0.10] /[0.10]',
      )}
    />
  )
}
  ...
  return (
    ...
    >
      <div
        className={classNames(
          className,
          'flex w-full h-full rounded-md overflow-hidden animate-pulse bg-white/[0.10]',
        )}
      />
    </div>
  )
