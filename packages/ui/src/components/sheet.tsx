...
const sheetVariants = cva(
  'border rounded-2xl fixed z-50 gap-4 paper border-accent bg-gray-100/80 /80 p-6 shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
